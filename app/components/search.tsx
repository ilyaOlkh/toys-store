    ...
    return (
        ...
        >
            ...
            <div className="flex items-center border-2 border-lightGray1 rounded-full w-full font-semibold ">
                ...
                />
                <button className="bg-blue1 text-white p-3 rounded-full transition-colors">
                    <Search />
                </button>
            </div>
                    ...
                    {searchQuery.length > minLen ? (
                        !loading ? (
                            searchResults.length > 0 ? (
                                ...
                                <li className="px-4 py-2">Немає результатів</li>
                            )
                        ) : (
                            <li className="px-4 py-2">завантаження...</li>
                        )
                    ) : (
